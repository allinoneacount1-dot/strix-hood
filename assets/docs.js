...
(function (global) {
  ...
  var INDEX = [
    ...
    {p:"docs.html",h:"disclosure",l:3,k:"Security model",t:"Audits and disclosure",s:"Report vulnerabilities to security@strixhood.xyz with the PGP key published at /.well-known/security.txt . Do not open a public issue. Disclosure target is 90 days or on-fix, whichever comes first. 08 — $STRX",w:"scope firm date status core contracts router vault registry spearbit 2026-03 2026 complete medium resolved session-key session validator module openzeppelin 2026-05 high solver auction bonding trail bits 2026-07 progress continuous immunefi bug bounty ongoing 500 000 critical strixhood.xyz well-known security.txt on-fix protocol"},
    {p:"docs.html",h:"tokenomics",l:2,k:"Economics & networks",t:"Tokenomics",s:"$STRX exists to make agent identity expensive to fake and dishonest execution expensive to attempt. It is a work token and a bond, not a payment rail — commerce settles in USDC, WETH and the assets being traded.",w:"economics networks"},
    {p:"docs.html",h:"supply",l:3,k:"Tokenomics",t:"Supply and distribution",s:"1,000,000,000 Total supply, fixed Base Canonical chain 18 Decimals None Inflation after TGE Community & Ecosystem 40% Team & Advisors 20% Protocol Treasury 15% Liquidity 15% Early Contributors 10%",w:"allocation unlock schedule share strx controlled 400 48-month month linear emission stakers solvers grant recipients emissions contract 200 12-month cliff 36-month vesting escrow 150 unlocked governance-gated governance gated spend requires passed proposal 48-hour hour timelock initial depth remainder released against targets months multisig 100 6-month 24-month economics networks"},
    ...
    {p:"docs.html",h:"networks",l:2,k:"Economics & networks",t:"Networks & contracts",s:"Seven networks are live. EVM contracts are deployed with CREATE2 from the same factory, so every EVM chain shares one address per contract. Solana runs a separate program set.",w:"economics"},
    {p:"docs.html",h:"supported-chains",l:3,k:"Networks & contracts",t:"Supported chains",s:"Testnets mirror the same contract addresses on Base Sepolia ( eip155:84532 ), Arbitrum Sepolia ( eip155:421614 ) and Solana devnet. Use a strx_sk_test_ key; live keys are rejected against testnet chains and vice versa.",w:"network chain caip-2 caip finality target gas asset status ethereum epochs min eth 8453 inclusion 42161 mainnet polygon pos 137 128 blocks pol bnb 5eykt4us slots sol beta strx_sk_test_ economics"},
    {p:"docs.html",h:"contract-addresses",l:3,k:"Networks & contracts",t:"Contract addresses",s:"Identical on Ethereum, Base, Arbitrum, OP Mainnet, Polygon and BNB Chain. Verify before you approve anything: the addresses below are also published in @strixhood/sdk/deployments.json and in the repository release tags. Verify before approving Nobody from Stri",w:"deployments.json evm create2 address every network purpose explorer intentrouter 0x5cf9a2b1e1d4a86f0c3d7b4e9f 2a08c5d6e13b47 accepts routed intents opens solver auction forwards winner basescan policyregistry 0x8ae4c0f37d1b52e9a6c8f401b2 d73e5a9c0f18db live policy hash agent source truth validator module agentpassport 0x2fb1d8c47a0e35b9d6f82c11e7 a4508d3bc96ef2 erc-721 erc 721 identity dynamic metadata capability traits revenue rights settlementvault 0x9d07e5a2c43b81f6e0a29d5c7b 4831fe62ac0d75 enforces minimum output takes splits"},
    {p:"docs.html",h:"limits",l:2,k:"Economics & networks",t:"Rate limits & pricing",s:"Subscription tiers buy throughput and support. They do not change the 0.25% protocol fee, and they do not change what a policy allows.",w:"0.25 economics networks"},
    {p:"docs.html",h:"tiers",l:3,k:"Rate limits & pricing",t:"Tiers",s:"Overage on intents per month is billed at $0.004 per intent rather than blocked, so a traffic spike degrades your invoice and not your agents. Overage on requests per minute is never billed — it is rate limited.",w:"tier price min concurrent connections webhooks networks support sandbox 000 testnets community builder 600 email business days growth 499 200 500 99.9 sla scale 100 priority solver lane shared channel 99.95 enterprise custom negotiated unmetered private pool named engineer 99.99 0.004 economics"},
